...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <h4 align="center">
            These are 10 random Quotes 
            <a href="#" onclick="getTenRandomQuotes()" title="Reload random Quotes"> <i class="fa fa-refresh"></i> </a>
        </h4>

        <div align="right" class="alert">

            <a href="favorite-quotes" class="btn btn-danger">
                <i class="fa fa-heart"></i> My Favorite Quotes
            </a>
